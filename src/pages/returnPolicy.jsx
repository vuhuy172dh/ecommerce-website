        ...
        <div>
            <div className="mx-6 laptop:mx-20 laptop:flex laptop:gap-20">
                <div className="laptop:w-8/12">
                    <div className="mb-8">
                        <h3 className="text-center laptop:text-left text-h3 font-medium mb-5 text-dark_primary">What is the return policy at Avion?</h3>
                        <p className="text-center text-h6 font-normal laptop:text-left">22 Thg 10, 2022</p>
                    </div>
                        ...
                        <div className="bg-dark_primary h-[24px] laptop:h-[48px] relative mb-5 mt-10 rounded">
                            <div className="flex items-center gap-3 absolute left-[20px] laptop:left-1/4 top-1/2 -translate-y-1/2">
                                <div className="w-[50px] h-[50px] laptop:w-[100px] laptop:h-[100px] rounded-full border-2 border-dark_primary bg-white flex">
                                    <FontAwesomeIcon className="m-auto text-[30px] text-dark_primary laptop:text-[60px]" icon={faArrowsRotate}/>
                                </div>
                                <h3 className="font-normal text-body-sm laptop:text-body-lg text-white">Policy application period</h3>
                            </div>
                        </div>
                        {/* Table */}
                            ...
                            <tbody>
                                ...
                                <tr className="bg-primary">
                                    ...
                                    <th className="w-1/5 border-2 border-dark_primary px-4 py-3 text-left">
                                        <p className="text-white text-h6 font-normal">SINCE THE DELIVERY IS SUCCESSFUL</p>
                                    </th>
                                    <th className="w-1/5 border-2 border-dark_primary px-4 py-3 text-left">
                                        <p className="text-white text-h6 font-normal">PRODUCTS ERROR</p>
                                    </th>
                                    <th className="w-1/5 border-2 border-dark_primary px-4 py-3 text-left">
                                        <p className="text-white text-h6 font-normal">PRODUCTS WITHOUT ERROR</p>
                                    </th>
                                    <th className="w-1/5 border-2 border-dark_primary px-4 py-3 text-left">
                                        <p className="text-white text-h6 font-normal">PRODUCT DAMAGED BY USERS</p>
                                    </th>
                                </tr>
                                {/* Table Row-1 */}
                                <tr>
                                    <td rowSpan="4" className="w-1/5 border-2 border-dark_primary px-4 py-3">
                                        <p className="text-dark_primary text-h5 font-medium">Types of lights</p>
                                    </td>
                                    <td rowSpan="2" className="w-1/5 border-2 border-dark_primary px-4 py-3">
                                        <p className="text-dark_primary text-h5 font-medium">
                                            first 7 days
                                        </p>
                                    </td>
                                    <td className="w-1/5 border-2 border-dark_primary px-4 py-3">
                                        <p className="text-dark_primary text-h5 font-medium">Renew</p>
                                    </td>
                                    <td rowSpan="4" className="w-1/5 border-2 border-dark_primary px-4 py-3">
                                        <p className="text-dark_primary text-h5 font-medium">Does not support return</p>
                                    </td>
                                    <td rowSpan="4" className="w-1/5 border-2 border-dark_primary px-4 py-3">
                                        <p className="text-dark_primary text-h5 font-medium">
                                ...
                                <tr>
                                    <td className="w-1/5 border-2 border-dark_primary px-4 py-3">
                                        <p className="text-dark_primary text-h5 font-medium">8 - 30 days</p>
                                    </td>
                                    <td className="w-1/5 border-2 border-dark_primary px-4 py-3">
                                        <p className="text-dark_primary text-h5 font-medium">
                                            Guarantee
                                ...
                                <tr>
                                    <td className="w-1/5 border-2 border-dark_primary px-4 py-3">
                                        <p className="text-dark_primary text-h5 font-medium">30 days onwards</p>
                                    </td>
                                    <td className="w-1/5 border-2 border-dark_primary px-4 py-3">
                                        <p className="text-dark_primary text-h5 font-medium">Guarantee</p>
                                    </td>
                                </tr>
                                 {/* Table Row-2 */}
                                <tr>
                                    <td rowSpan="4" className="w-1/5 border-2 border-dark_primary px-4 py-3">
                                        <p className="text-dark_primary text-h5 font-medium">Types of tables and chairs</p>
                                    </td>
                                    <td rowSpan="2" className="w-1/5 border-2 border-dark_primary px-4 py-3">
                                        <p className="text-dark_primary text-h5 font-medium">
                                            first 7 days
                                    ...
                                    <td rowSpan="3" className="w-1/5 border-2 border-dark_primary px-4 py-3">
                                        <p className="text-dark_primary text-h5 font-medium">Does not support return</p>
                                    </td>
                                    <td rowSpan="4" className="w-1/5 border-2 border-dark_primary px-4 py-3">
                                        <p className="text-dark_primary text-h5 font-medium">
                                ...
                                <tr>
                                    <td className="w-1/5 border-2 border-dark_primary px-4 py-3">
                                        <p className="text-dark_primary text-h5 font-medium">Pay no fee</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td className="w-1/5 border-2 border-dark_primary px-4 py-3">
                                ...
                                <tr>
                                    ...
                                    <td className="w-1/5 border-2 border-dark_primary px-4 py-3">
                                        <p className="text-dark_primary text-h5 font-medium">Does not support exchange/return</p>
                                    </td>
                                </tr>
                                {/* Table Row-3 */}
                                <tr>
                                <td className="w-1/5 border-2 border-dark_primary px-4 py-3">
                                        <p className="text-dark_primary text-h5 font-medium">Types of household cabinets</p>
                                    </td>
                                    <td colSpan="4" className="border-2 border-dark_primary px-4 py-3">
                                        <p className="text-dark_primary text-h5 font-medium">
                                ...
                                <tr>
                                    ...
                                    <td rowSpan="2" className="w-1/5 border-2 border-dark_primary px-4 py-3">
                                        <p className="text-dark_primary text-h5 font-medium">first 30 days</p>
                                    </td>
                                    <td className="w-1/5 border-2 border-dark_primary px-4 py-3">
                                        <p className="text-dark_primary text-h5 font-medium">Renew</p>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td colSpan="3" className="w-1/5 border-2 border-dark_primary px-4 py-3">
                                        <p className="text-dark_primary text-h5 font-medium">Does not support exchange/return</p>
                                    </td>
                                </tr>
                                {/* Table Row-5 */}
                                ...
                                <tr>
                                    ...
                                    <td colSpan="2" className="w-1/5 border-2 border-dark_primary px-4 py-3">
                                        <p className="text-dark_primary text-h5 font-medium">Does not support exchange/return</p>
                                    </td>
                                </tr>
                            </tbody>
                    ...
                    <div className="mx-3 mt-10">
                        ...
                        <ul className="hidden laptop:block list-disc pl-10 mt-8">
                            <li className="font-h5">
                                To ensure the interests of customers and Avion has the basis to work with relevant departments, all requests for exchange/return/warranty you need to provide pictures/videos of defective products. Past the time to exchange / return products, if we have not received enough pictures / clips from customers, Avion would like to refuse to support. Besides, you need to record a video clip of product packaging as proof of comparison/complaint related to return and exchange later (if necessary).
                            </li>
                            <li className="font-h5 mt-5">
                                In addition to the general policy on time and conditions of return, exchange/return/warranty policy for products in the group of Gifts, Products/Services purchased with, Buy with discount, there are some additional conditions such as: after:
                            </li>
                        </ul>
                            ...
                            <tbody>
                                <tr className="bg-primary">
                                    ...
                                    <th className="w-1/3 border-2 border-dark_primary px-4 py-3 align-top">
                                        <p className="text-white text-h6 font-normal">BUNDLED GIFT</p>
                                    </th>
                                    <th className="w-1/3 border-2 border-dark_primary px-4 py-3 align-top">
                                        <p className="text-white text-h6 font-normal">PRODUCTS WITH BUY / BUY WITH MORE DISCOUNT</p>
                                    </th>
                                </tr>
                                <tr>
                                    <td className="w-1/3 border-2 border-dark_primary px-4 py-3 align-top">
                                        <p className="text-dark_primary text-h5 font-medium">Defective product (due to supplier)</p>
                                    </td>
                                    <td className="w-1/3 border-2 border-dark_primary px-4 py-3 align-top">
                                        <p className="text-dark_primary text-h5 font-medium">Exchange (faulty main product) or Return the full set</p>
                                    </td>
                                    <td className="w-1/3 border-2 border-dark_primary px-4 py-3 align-top">
                                        <p className="text-dark_primary text-h5 font-medium">Exchange defective products or Return the full set</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td className="w-1/3 border-2 border-dark_primary px-4 py-3 align-top">
                                        <p className="text-dark_primary text-h5 font-medium">Product is not defective</p>
                                    </td>
                                    <td className="w-1/3 border-2 border-dark_primary px-4 py-3 align-top">
                                        <p className="text-dark_primary text-h5 font-medium">Return the whole set</p>
                                    </td>
                                    <td className="w-1/3 border-2 border-dark_primary px-4 py-3 align-top">
                                        <p className="text-dark_primary text-h5 font-medium">Return the whole set</p>
                                    </td>
                ...
                <div className="mx-3 laptop:w-4/12">
                    <h3 className="text-center laptop:text-left text-h3 font-medium mb-5 mt-10 laptop:mt-0 text-dark_primary">Frequently asked questions</h3>
