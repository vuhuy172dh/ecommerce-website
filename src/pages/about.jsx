  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 laptop:grid-cols-2 mx-auto">
        ...
        {/* Feature 2 */}
        <div>
          <img src={feature2} alt="feature2" className="object-cover" />
        </div>
        {/* Feature 3 */}
        <div>
          <img src={feature3} alt="feature1" className="object-cover" />
        </div>
        {/* Feature 4*/}
        <div>
          <div className="px-6 mt-12 mb-9 laptop:px-28  laptop:pt-20">
            ...
            <p className="text-body-sm laptop:text-body-md mt-3 laptop:text-4">
              When we started Avion, the idea was simple. Make high quality
              furniture affordable and available for the mass market. <br />
